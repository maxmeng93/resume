...
let data = {
  ...
  projects: [
    ...
    },
    {
      ...
      company: '生工生物工程（上海）股份有限公司',
      details: [
        '生产执行管理系统(MES)内对接了公司的生产销售流程。系统内原有销售管理、合成管理、基因合成、测序管理、审批管理、快递管理、系统管理等7个子项目，我加入公司后又陆续开发了新测序管理、采购管理、人事管理、预算管理、基础数据、多肽合成管理、RNA合成管理等多个项目，这些项目会在下面分开介绍。',
    ...
    },
    {
      ...
      company: '生工生物工程（上海）股份有限公司',
      details: [
        'BBI集团是生工生物的控股公司，这个官网是为了上市公司披露财务信息、发布最新公告、介绍公司产品等目的而开发的。这个官网采用了Vue、Vuex、Nuxtjs、Nust-i18n等技术栈，最终成果是一个三种语言国际化、服务端渲染的项目。上线后也使用了PM2做进程管理。'
      ],
    },
    {
      ...
      company: '生工生物工程（上海）股份有限公司',
      details: [
        '这是一个集团内部员工使用的一个系统，目前的功能只有薪资查询。每月薪资由人事负责从MES系统中的人事管理上传。',
